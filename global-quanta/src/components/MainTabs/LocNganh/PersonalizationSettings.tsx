...
/**
 * GIAI DOAN 1: cai dat nay hien CHI anh huong nguong hien thi CANH BAO o
 * Frontend (WarningBanner) - backend van tinh Quality Score theo trong so
 * co dinh 40/20/20/20. Ket noi "trong so tuy chinh" toi backend can them 1
 * tham so query moi, chua lam o giai doan nay (danh dau ro trong description
 * neu can, tranh nguoi dung tuong da doi duoc cach tinh diem goc).
 */
